...
// The status
router.get('/status', middleware.serviceKeyCheck, (req, res) => {
  res.status(200).send()
});

// The test/setup endpoint
router.post('/test/setup', middleware.serviceKeyCheck, (req, res) => {
...
// Trigger endpoints
router.post('/triggers/new_thing_created', (req, res) => {
...
// Query endpoints
router.post('/queries/list_all_things', (req, res) => {
...
// Action endpoints
router.post('/actions/create_new_thing', (req, res) => {
